<template>
  <div id="home">
    <div id="ui">
      ...
      <button
        @click="toggleRun"
        class="btn btn-primary d-block mx-auto w-100 mb-2"
      >
      ...
      <div id="preview">
        <button
          class="play-file"
          v-for="audioFile in this.audioFiles"
          @click="previewAudio(audioFile)"
        >
          {{ audioFile }}
        </button>
      </div>
      ...
      <div class="tab">
        ...
        <div class="drop show" id="load-examples">
          ...
          <div
            ...
            aria-labelledby="load-examples-toggle"
          >
            <span
              class="dropdown-item"
              v-for="(value, key, index) in this.examples"
              @click="loadCode(value)"
              >{{ key }}</span
            >
          </div>
        </div>
